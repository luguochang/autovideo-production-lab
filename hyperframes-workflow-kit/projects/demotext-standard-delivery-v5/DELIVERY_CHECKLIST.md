# Standard Delivery Checklist - demotext-standard-delivery-v5
...
- [x] 18-scene storyboard, shot manifest, Graph IR and production manifest
...
- [x] 18 scene midpoint frames prepared for inspection
- [x] Studio timeline loaded with 18 scenes, 46 captions and final audio
