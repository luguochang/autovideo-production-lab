# AutoVideo Runbook - demotext-standard-delivery-v5
...
Open HyperFrames Studio from the workbench and review the full 239.328-second timeline. Approve only after the current composition digest matches the review receipt.
