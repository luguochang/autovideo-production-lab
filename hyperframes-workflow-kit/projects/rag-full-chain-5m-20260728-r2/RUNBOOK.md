# AutoVideo Runbook - rag-full-chain-5m-20260728-r2
...
npx.cmd --yes hyperframes@0.7.77 check hyperframes-workflow-kit/projects/<project-id>/production/hyperframes --strict --json
...
Open HyperFrames Studio from the workbench and review the full 1880.218-second timeline. Approve only after the current composition digest matches the review receipt.
