# Standard Delivery Checklist - rag-full-chain-5m-20260728-r2
...
- [x] 48kHz mono PCM final WAV and 237 part receipts
- [x] Locked alignment, 237-cue SRT and alignment reconstruction QA
- [x] Content approval, claim ledger and pronunciation ledger
- [x] 71-scene storyboard, shot manifest, Graph IR and production manifest
...
- [x] 71 scene midpoint frames prepared for inspection
- [x] Studio timeline loaded with 71 scenes, 237 captions and final audio
...
- [ ] Full human listening and 0 pronunciation decisions
