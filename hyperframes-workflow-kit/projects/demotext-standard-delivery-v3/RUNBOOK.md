# AutoVideo Runbook - demotext-standard-delivery-v3
...
Open HyperFrames Studio from the workbench and review the full 242.904042-second timeline. Approve only after the current composition digest matches the review receipt.
