# Standard Delivery Checklist - batch-smoke-30s-20260720
...
- [x] 48kHz mono PCM final WAV and 4 part receipts
- [x] Locked alignment, 6-cue SRT and alignment reconstruction QA
- [x] Content approval, claim ledger and pronunciation ledger
- [x] 2-scene storyboard, shot manifest, Graph IR and production manifest
...
- [x] 2 scene midpoint frames prepared for inspection
- [x] Studio timeline loaded with 2 scenes, 6 captions and final audio
